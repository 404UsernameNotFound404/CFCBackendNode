...
const userVerificationCodeModel = require("../user/verficationCodeModel");
...
module.exports = {
  user: new model(
    ...
    getDB,
    userModel.allowedEntries,
    userModel.isArray
  ),
  userVerificationCode: new model(
    userVerificationCodeModel.collectionName,
    getDB,
    userVerificationCodeModel.allowedEntries,
    userVerificationCodeModel.isArray
  ),
  page: new model(
    page.collectionName,
    getDB,
  ...
  orgChangeRequest: new model(
    orgChangeRequestModel.collectionName,
    getDB,
    orgChangeRequestModel.allowedEntries,
    orgChangeRequestModel.isArray
  ),
};
